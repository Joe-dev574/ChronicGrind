...
struct HealthKitPromptView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text(
                "FitSync requires access to HealthKit to synchronize your workout and health data. This enables features such as automatic tracking, personalized fitness insights, and seamless integration with your health metrics."
            )
            .font(.body)
